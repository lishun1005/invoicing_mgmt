...
var SPICE_MSG_DISPLAY_DRAW_FILL         = 302;// 已修复
var SPICE_MSG_DISPLAY_DRAW_OPAQUE       = 303;// 未出现
var SPICE_MSG_DISPLAY_DRAW_COPY         = 304;// 已修复
var SPICE_MSG_DISPLAY_DRAW_BLEND        = 305;// 已修复
var SPICE_MSG_DISPLAY_DRAW_BLACKNESS    = 306;// 未出现
var SPICE_MSG_DISPLAY_DRAW_WHITENESS    = 307;// 未出现
var SPICE_MSG_DISPLAY_DRAW_INVERS       = 308;// 已修复
var SPICE_MSG_DISPLAY_DRAW_ROP3         = 309;// 已修复
var SPICE_MSG_DISPLAY_DRAW_STROKE       = 310;// 已修复
var SPICE_MSG_DISPLAY_DRAW_TEXT         = 311;// 已修复
var SPICE_MSG_DISPLAY_DRAW_TRANSPARENT  = 312;// 已修复
var SPICE_MSG_DISPLAY_DRAW_ALPHA_BLEND  = 313;// 已修复
var SPICE_MSG_DISPLAY_SURFACE_CREATE    = 314;// 已修复
var SPICE_MSG_DISPLAY_SURFACE_DESTROY   = 315;// 已修复
...
var SPICE_IMAGE_TYPE_BITMAP         = 0;// 已修复
var SPICE_IMAGE_TYPE_QUIC           = 1;// 已修复
var SPICE_IMAGE_TYPE_RESERVED       = 2;// 未出现
var SPICE_IMAGE_TYPE_LZ_PLT         = 100;// 已修复
var SPICE_IMAGE_TYPE_LZ_RGB         = 101;// 已修复
var SPICE_IMAGE_TYPE_GLZ_RGB        = 102;// 禁用
var SPICE_IMAGE_TYPE_FROM_CACHE     = 103;// 已修复
var SPICE_IMAGE_TYPE_SURFACE        = 104;// 未出现
var SPICE_IMAGE_TYPE_JPEG           = 105;// 禁用
var SPICE_IMAGE_TYPE_FROM_CACHE_LOSSLESS = 106;// 已修复
var SPICE_IMAGE_TYPE_ZLIB_GLZ_RGB   = 107;// 禁用
var SPICE_IMAGE_TYPE_JPEG_ALPHA     = 108;// 禁用
...
var SPICE_BITMAP_FMT_INVALID        = 0,// 未出现
    SPICE_BITMAP_FMT_1BIT_LE        = 1,// 未出现
    SPICE_BITMAP_FMT_1BIT_BE        = 2,// 已修复
    SPICE_BITMAP_FMT_4BIT_LE        = 3,// 未出现
    SPICE_BITMAP_FMT_4BIT_BE        = 4,// 已修复
    SPICE_BITMAP_FMT_8BIT           = 5,// 已修复
    SPICE_BITMAP_FMT_16BIT          = 6,// 未出现
    SPICE_BITMAP_FMT_24BIT          = 7,// 已修复
    SPICE_BITMAP_FMT_32BIT          = 8,// 已修复
    SPICE_BITMAP_FMT_RGBA           = 9;// 已修复
...
var LZ_IMAGE_TYPE_INVALID = 0,// 未出现
    LZ_IMAGE_TYPE_PLT1_LE = 1,// 未出现
    LZ_IMAGE_TYPE_PLT1_BE = 2,// 已修复
    LZ_IMAGE_TYPE_PLT4_LE = 3,// 未出现
    LZ_IMAGE_TYPE_PLT4_BE = 4,// 已修复
    LZ_IMAGE_TYPE_PLT8    = 5,// 已修复
    LZ_IMAGE_TYPE_RGB16   = 6,// 未出现
    LZ_IMAGE_TYPE_RGB24   = 7,// 已修复
    LZ_IMAGE_TYPE_RGB32   = 8,// 已修复
    LZ_IMAGE_TYPE_RGBA    = 9,// 已修复
    LZ_IMAGE_TYPE_XXXA    = 10;// 已修复
...
//=========================================
var SPICE_STRING_FLAGS_RASTER_A1 = 1,
    SPICE_STRING_FLAGS_RASTER_A4 = 2,
    SPICE_STRING_FLAGS_RASTER_A8 = 8;



var VD_AGENT_PROTOCOL = 1 ,
    VD_AGENT_MONITORS_CONFIG = 2,
    VD_AGENT_CONFIG_MONITORS_FLAG_USE_POS = 1;


var OUTER_NET_HOST = "202.104.180.14";


var SPICE_PATH_BEGIN = (1 << 0),
    SPICE_PATH_END = (1 << 1),
    SPICE_PATH_CLOSE = (1 << 3),
    SPICE_PATH_BEZIER = (1 << 4);

var AGENT_MONITORS_TIMEOUT = 2000;