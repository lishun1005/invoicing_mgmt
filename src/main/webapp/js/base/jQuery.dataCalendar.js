		...
		"openCalendar": function(element){
			...
			function calendar(){
				...
				function showCalendar(monthNum,year){
					...
					$(".currentMonth").val(parseInt(currentMonth));
				...
				var currentYear = estr[0];
				var currentMonth = estr[1]; //monthNum%12;
				showCalendar(currentMonth,currentYear);*/
				
				var monthNum = todayMonth+1; //获得当前月
				var year = thisYear; /*获得当前年*/
				...
				var currentY = parseInt($(".currentYear option:selected").val());
				var currentM = parseInt($(".currentMonth option:selected").val());
				year = currentY;
				showCalendar(currentM,year);
